...
RUN cd /var/www/html/lodspeakr; ./install.sh base-url=http://localhost:8080/ base-namespace=http://virtuoso.nrgi-dev.default.opendataservices.uk0.bigv.io/ sparql-endpoint=http://virtuoso:8890/sparql
